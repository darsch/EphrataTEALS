package studentWork.WarGameLab;


import java.util.*; //Import Random and Scanner
...
public class CardWar {
    ...
    */
    ...
    // Check for high card
        public static boolean checkHighCard() {
        int tableSize = table.size();
        int lastCard;
        int topCard;
        ...
        if (tableSize < 2) {
            ...
            lastCard = table.get(tableSize - 1).getValue();
            topCard = table.get(tableSize - 2).getValue();
        }
